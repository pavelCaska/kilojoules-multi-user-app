...
public class BootstrapData implements CommandLineRunner {
    ...
    public BootstrapData(UserService userService, UserProfileService userProfileService, FoodRepository foodRepository, FoodCsvService foodCsvService, FoodService foodService, PortionService portionService, MealService mealService, JournalService journalService, JournalMealService journalMealService) {
    ...
    private void populateUserProfiles() {
        ...
        UserProfile profile2 = UserProfile.builder()
                ...
                .country("USA")
                .build();
        userProfileService.save(profile2);
    }
    ...
    private void populateJournalWithFoods() {
        ...
        Journal journal = journalService.addFoodToJournal(user, foodTest1, quantity, today, mealType, foodName);
        ...
        Journal journalT2 = journalService.addFoodToJournal(user, foodTest2, quantityT2, today, mealTypeT2, foodNameT2);
        ...
        Journal journal1 = journalService.addFoodToJournal(user, food1, quantity1, today, mealType1, foodName1);
        ...
        Journal journal2 = journalService.addFoodToJournal(user, food2, quantity2, today, mealType2, foodName2);
        ...
        Journal journal3 = journalService.addFoodToJournal(user, food3, quantity3, today, mealType3, foodName3);
        ...
        Journal journal4 = journalService.addFoodToJournal(user, food4, quantity4, yesterday, mealType4, foodName4);
        ...
        Journal journal5 = journalService.addFoodToJournal(user, food5, quantity5, yesterday, mealType5, foodName5);
        ...
        Journal journal6 = journalService.addFoodToJournal(user, food6, quantity6, yesterday, mealType6, foodName6);
        ...
        Journal journal7 = journalService.addFoodToJournal(user, food7, quantity7, dayBeforeYesterday, mealType7, foodName7);
        ...
        Journal journal8 = journalService.addFoodToJournal(user, food8, quantity8, dayBeforeYesterday, mealType8, foodName8);
    }

    private void populateJournalWithMeals() {
        User user = userService.fetchUserByUsername("activeUser");
        Meal meal = mealService.getMealByIdAndUser(5L, user);
