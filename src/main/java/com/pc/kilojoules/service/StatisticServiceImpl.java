...
import com.pc.kilojoules.entity.JournalEntry;
...
public class StatisticServiceImpl implements StatisticService {
    ...
    @Override
    public JournalTotalsDTO calculateJournalTotalsByDate(LocalDate date, User user) {
    ...
    @Override
    public JournalTotalsDTO calculateJournalTotalsByPeriod(LocalDate startDate, LocalDate endDate, User user) {
        JournalTotalsDTO journalTotalsDTO = new JournalTotalsDTO();
